...
mkfs/mkfs: mkfs/mkfs.c $K/fs.h
	gcc -Werror -Wall -Wno-nullability-completeness -I. -o mkfs/mkfs mkfs/mkfs.c
...
fs.img: mkfs/mkfs xv6-readme user/xargstest.sh $(UPROGS)
	mkfs/mkfs fs.img xv6-readme user/xargstest.sh $(UPROGS)
